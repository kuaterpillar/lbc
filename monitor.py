...
def get_simulated_data() -> list[lbc.Ad]:
    ...
    simulated_raw = [
        ...
        {
            "list_id": 2847593850,
            "subject": "Yamaha MT 07 accidenté pour pièces",
            "price_cents": 150000,
            "url": "https://www.leboncoin.fr/motos/2847593850.htm",
            "first_publication_date": "2025-01-28T07:00:00",
            "index_date": "2025-01-28T07:00:00",
            "expiration_date": "2025-03-28T07:00:00",
            "status": "active",
            "category_id": "3",
            "category_name": "Motos",
            "body": "MT07 accidenté, moteur tourne, carénage cassé, beaucoup de pièces à changer",
            "brand": "Yamaha",
            "ad_type": "offer",
            "has_phone": False,
            "images": {"urls_large": ["https://example.com/image4.jpg"]},
            "location": {
            ...
            "attributes": [
                {"key": "mileage", "value": "25000", "value_label": "25 000 km"},
